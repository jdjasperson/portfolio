...
public class TrieNode {
	...
	public TrieNode(char edge, String prefix, boolean isWord) {
		this.edge = edge;
		this.prefix = prefix;
		this.isWord = isWord;
	}
	...
	private int getChildIndex(char edge) {
		...
		if (ascii <= TrieNode.LOWERCASE_INDEX2 && ascii >= TrieNode.LOWERCASE_INDEX1) {
			return ascii - TrieNode.LOWERCASE_OFFSET;
		}
